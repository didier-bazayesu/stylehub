...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login and receive access token + refresh cookie' }),
    __param(0, (0, common_1.Body)()),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Refresh access token using refresh cookie' }),
